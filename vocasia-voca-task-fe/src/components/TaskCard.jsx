...
function TaskCard({ task, onDelete, onDone }) {
  return (
    <div className="flex w-full gap-2">
      ...
      <button
        onClick={onDone}
        className="h-max p-2 my-2 flex items-center justify-center text-white bg-gradient-to-b from-green-400 to-green-500 rounded-[15px]"
      >
        <svg
          width="24"
          height="24"
      ...
      <button
        onClick={onDelete}
        className="h-max p-2 my-2 flex items-center justify-center text-white bg-gradient-to-b from-red-400 to-red-500 rounded-[15px]"
      >
        <svg
          width="24"
          height="24"
